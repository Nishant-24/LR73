...
public class LoginUtil {
	...
	public static Map<String, String> getEmailDefinitionTerms(PortletRequest portletRequest, String emailFromAddress,
		...
		Map<String, String> definitionTerms = LinkedHashMapBuilder
				.put("[$FROM_ADDRESS$]", HtmlUtil.escape(emailFromAddress))
				.put("[$FROM_NAME$]", HtmlUtil.escape(emailFromName)).build();
	...
	public static String getEmailTemplateXML(PortletPreferences portletPreferences, PortletRequest portletRequest,
		...
		if (xml == null) {
			...
			String defaultContent = ContentUtil.get(PortalClassLoaderUtil.getClassLoader(),
	...
	public static String getLogin(HttpServletRequest httpServletRequest, String paramName, Company company) {
		...
		if ((login == null) || login.equals(StringPool.NULL)) {
			login = CookieKeys.getCookie(httpServletRequest, CookieKeys.LOGIN, false);
	...
	public static PortletURL getLoginURL(HttpServletRequest httpServletRequest, long plid)
		...
		PortletURL portletURL = PortletURLFactoryUtil.create(httpServletRequest, LoginPortletKeys.LOGIN, plid,
