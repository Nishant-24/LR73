...
public class StagingAuthorizationModelImpl
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StagingAuthorization)) {
			return false;
		}

		StagingAuthorization stagingAuthorization = (StagingAuthorization)obj;
	...
	public void resetOriginalValues() {
		StagingAuthorizationModelImpl stagingAuthorizationModelImpl = this;

		stagingAuthorizationModelImpl._originalExternalCaseId =
			stagingAuthorizationModelImpl._externalCaseId;

		stagingAuthorizationModelImpl._setOriginalExternalCaseId = false;

		stagingAuthorizationModelImpl._columnBitmask = 0;
	}
