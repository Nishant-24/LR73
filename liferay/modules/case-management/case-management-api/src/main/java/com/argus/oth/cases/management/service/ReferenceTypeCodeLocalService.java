...
public interface ReferenceTypeCodeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ReferenceTypeCodeLocalServiceUtil} to access the reference type code local service. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.ReferenceTypeCodeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
