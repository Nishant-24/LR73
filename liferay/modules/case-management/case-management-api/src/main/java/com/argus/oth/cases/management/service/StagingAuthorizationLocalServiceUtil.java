...
public class StagingAuthorizationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>StagingAuthorizationLocalService</code> via injection or a <code>ServiceTracker</code> or use <code>StagingAuthorizationLocalServiceUtil</code>.
	 */
	 ...
	 */
	public static com.argus.oth.cases.management.model.StagingAuthorization
					...
					new ServiceTracker
						<StagingAuthorizationLocalService,
						 StagingAuthorizationLocalService>(
							 ...
							 StagingAuthorizationLocalService.class, null);
