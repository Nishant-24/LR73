 ...
 */
@Component(
	immediate = true, property = "indexer.class.name=com.argus.oth.cases.management.model.Cases",
	service = ModelPreFilterContributor.class
)
public class CasesModelPreFilterContributor implements ModelPreFilterContributor {
	...
	public void contribute(
		...
		booleanFilter.addRangeTerm(Field.getSortableFieldName(OTHConstants.FIELD_LAST_UPDATED), startDate, endDate);
	}
