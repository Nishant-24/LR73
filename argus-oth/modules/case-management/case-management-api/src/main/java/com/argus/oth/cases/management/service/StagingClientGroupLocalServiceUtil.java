...
public class StagingClientGroupLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>StagingClientGroupLocalService</code> via injection or a <code>ServiceTracker</code> or use <code>StagingClientGroupLocalServiceUtil</code>.
	 */
	public static com.argus.oth.cases.management.model.StagingClientGroup
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			StagingClientGroupLocalService.class);
					...
					new ServiceTracker
						<StagingClientGroupLocalService,
						 StagingClientGroupLocalService>(
							 ...
							 StagingClientGroupLocalService.class, null);
