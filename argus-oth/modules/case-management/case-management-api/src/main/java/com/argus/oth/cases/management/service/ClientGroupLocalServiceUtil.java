...
/**
 * Provides the local service utility for ClientGroup. This utility wraps
 * <code>com.argus.oth.cases.management.service.impl.ClientGroupLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ClientGroupLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.ClientGroupLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.argus.oth.cases.management.model.ClientGroup
		addClientGroup(
			com.argus.oth.cases.management.model.ClientGroup clientGroup) {

		return getService().addClientGroup(clientGroup);
	}

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>ClientGroupLocalService</code> via injection or a <code>ServiceTracker</code> or use <code>ClientGroupLocalServiceUtil</code>.
	 */
	public static com.argus.oth.cases.management.model.ClientGroup
		addClientGroup(
			long groupId, long externalClientGroupId, long clientId,
			String clientGroup, String clientGroupName,
			java.util.Date modifiedDate, java.util.Date createdDate,
			String randomString) {

		return getService().addClientGroup(
	 ...
	 */
	public static com.argus.oth.cases.management.model.ClientGroup
		createClientGroup(long clientGroupId) {

		return getService().createClientGroup(clientGroupId);
	}
	...
	public static com.argus.oth.cases.management.model.ClientGroup
		...
		return getService().deleteClientGroup(clientGroup);
	}
	 ...
	 */
	public static com.argus.oth.cases.management.model.ClientGroup
			deleteClientGroup(long clientGroupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteClientGroup(clientGroupId);
	}
	...
	public static com.argus.oth.cases.management.model.ClientGroup
		...
		return getService().fetchByExternalClientGroupId(externalClientGroupId);
	}

	public static com.argus.oth.cases.management.model.ClientGroup
		fetchClientGroup(long clientGroupId) {

		return getService().fetchClientGroup(clientGroupId);
	}
	 ...
	 */
	public static com.argus.oth.cases.management.model.ClientGroup
			getClientGroup(long clientGroupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getClientGroup(clientGroupId);
	}
	...
	public static java.util.List
		<com.argus.oth.cases.management.model.ClientGroup> getClientGroups(
			int start, int end) {

		return getService().getClientGroups(start, end);
	}
	 ...
	 */
	public static int getClientGroupsCount() {
		return getService().getClientGroupsCount();
	}
	...
	public static com.argus.oth.cases.management.model.ClientGroup
		...
		return getService().updateClientGroup(clientGroup);
	}

	public static ClientGroupLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<ClientGroupLocalService, ClientGroupLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ClientGroupLocalService.class);

		ServiceTracker<ClientGroupLocalService, ClientGroupLocalService>
			serviceTracker =
				new ServiceTracker
					<ClientGroupLocalService, ClientGroupLocalService>(
						bundle.getBundleContext(),
						ClientGroupLocalService.class, null);
