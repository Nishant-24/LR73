...
public interface NotePersistence extends BasePersistence<Note> {
	 ...
	 * @return the matching notes
	 */
	public java.util.List<Note> findByC_NotP(long caseId, String processStatus);
	 ...
	 * @return the range of matching notes
	 */
	public java.util.List<Note> findByC_NotP(
	 ...
	 * @return the matching notes
	 */
	public java.util.List<Note> findByE_P(
	 ...
	 * @return the matching notes
	 */
	public java.util.List<Note> findByRowProcessed_ProcessStatus(
