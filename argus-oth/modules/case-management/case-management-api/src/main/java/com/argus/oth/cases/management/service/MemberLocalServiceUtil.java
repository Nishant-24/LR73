 ...
 * <code>com.argus.oth.cases.management.service.impl.MemberLocalServiceImpl</code> and
...
public class MemberLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.MemberLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>MemberLocalService</code> via injection or a <code>ServiceTracker</code> or use <code>MemberLocalServiceUtil</code>.
	 */
	public static com.argus.oth.cases.management.model.Member addMember(
	 ...
	 */
	public static com.argus.oth.cases.management.model.Member createMember(
		long memberId) {
	 ...
	 */
	public static com.argus.oth.cases.management.model.Member deleteMember(
			long memberId)
	...
	public static com.argus.oth.cases.management.model.Member
		fetchByExternalMemberId(long externalMemberId) {

		return getService().fetchByExternalMemberId(externalMemberId);
	}

	public static com.argus.oth.cases.management.model.Member fetchMember(
		long memberId) {
	 ...
	 * @throws PortalException if a member with the primary key could not be found
	 */
	public static com.argus.oth.cases.management.model.Member getMember(
			long memberId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.argus.oth.cases.management.model.Member>
	 ...
	 */
	public static com.argus.oth.cases.management.model.Member updateMember(
		com.argus.oth.cases.management.model.Member member) {

		return getService().updateMember(member);
	}

	public static com.argus.oth.cases.management.model.Member upsertMember(
		long groupId, long clientId, long clientGroupId,
		io.swagger.client.model.Type2 member) {

		return getService().upsertMember(
