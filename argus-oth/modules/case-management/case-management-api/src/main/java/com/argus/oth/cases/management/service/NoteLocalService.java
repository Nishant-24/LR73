...
public interface NoteLocalService
	...
	public Note addNote(
		...
		String code, String direction, long externalNoteId, Date noteCreateDate,
		String noteType, String type, String text, String processStatus,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Note> getNotesByC_NotP(
