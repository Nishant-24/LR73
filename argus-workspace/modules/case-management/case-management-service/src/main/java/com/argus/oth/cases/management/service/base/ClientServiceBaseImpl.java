...
import com.argus.oth.cases.management.service.ClientService;
import com.argus.oth.cases.management.service.ClientServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.argus.oth.cases.management.service.impl.ClientServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.argus.oth.cases.management.service.impl.ClientServiceImpl
 * @generated
 */
public abstract class ClientServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClientService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ClientServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setServiceUtilService(clientService);
	}
	...
	private void _setServiceUtilService(ClientService clientService) {
		try {
			Field field = ClientServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, clientService);
		}
	...
	@Reference
	protected com.argus.oth.cases.management.service.ClientLocalService
		clientLocalService;
