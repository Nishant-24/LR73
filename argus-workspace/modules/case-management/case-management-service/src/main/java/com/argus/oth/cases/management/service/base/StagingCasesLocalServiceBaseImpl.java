...
import com.argus.oth.cases.management.service.StagingCasesLocalServiceUtil;
...
/**
 * Provides the base implementation for the staging cases local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.argus.oth.cases.management.service.impl.StagingCasesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.argus.oth.cases.management.service.impl.StagingCasesLocalServiceImpl
 * @generated
 */
public abstract class StagingCasesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, StagingCasesLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingCasesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingCasesLocalServiceUtil</code>.
	 */
	...
	public StagingCases addStagingCases(StagingCases stagingCases) {
		...
		return stagingCasesPersistence.update(stagingCases);
	}
	...
	public StagingCases createStagingCases(long stagingCaseId) {
		return stagingCasesPersistence.create(stagingCaseId);
	}
	...
	public StagingCases deleteStagingCases(long stagingCaseId)
		...
		return stagingCasesPersistence.remove(stagingCaseId);
	}
	...
	public StagingCases deleteStagingCases(StagingCases stagingCases) {
		return stagingCasesPersistence.remove(stagingCases);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			StagingCases.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stagingCasesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return stagingCasesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stagingCasesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return stagingCasesPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public StagingCases fetchStagingCases(long stagingCaseId) {
		return stagingCasesPersistence.fetchByPrimaryKey(stagingCaseId);
	}
	...
	public StagingCases getStagingCases(long stagingCaseId)
		...
		return stagingCasesPersistence.findByPrimaryKey(stagingCaseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stagingCasesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StagingCases.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("stagingCaseId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(StagingCases.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return stagingCasesLocalService.deleteStagingCases(
			(StagingCases)persistedModel);
	}

	public BasePersistence<StagingCases> getBasePersistence() {
		return stagingCasesPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return stagingCasesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<StagingCases> getStagingCaseses(int start, int end) {
		return stagingCasesPersistence.findAll(start, end);
	}
	...
	public int getStagingCasesesCount() {
		return stagingCasesPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StagingCasesLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		stagingCasesLocalService = (StagingCasesLocalService)aopProxy;

		_setLocalServiceUtilService(stagingCasesLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StagingCasesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stagingCasesPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = StagingCasesLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stagingCasesLocalService);
		}
	...
	protected StagingCasesLocalService stagingCasesLocalService;
