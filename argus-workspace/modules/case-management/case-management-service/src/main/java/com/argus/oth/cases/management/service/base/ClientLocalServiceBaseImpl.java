...
import com.argus.oth.cases.management.service.ClientLocalServiceUtil;
...
public abstract class ClientLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClientLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ClientLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(clientLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ClientLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, clientLocalService);
		}
