...
import com.argus.oth.cases.management.service.ClaimDetailLocalServiceUtil;
...
/**
 * Provides the base implementation for the claim detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.argus.oth.cases.management.service.impl.ClaimDetailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.argus.oth.cases.management.service.impl.ClaimDetailLocalServiceImpl
 * @generated
 */
public abstract class ClaimDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClaimDetailLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClaimDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ClaimDetailLocalServiceUtil</code>.
	 */
	...
	public ClaimDetail addClaimDetail(ClaimDetail claimDetail) {
		...
		return claimDetailPersistence.update(claimDetail);
	}
	...
	public ClaimDetail createClaimDetail(long claimDetailId) {
		return claimDetailPersistence.create(claimDetailId);
	}
	...
	public ClaimDetail deleteClaimDetail(long claimDetailId)
		...
		return claimDetailPersistence.remove(claimDetailId);
	}
	...
	public ClaimDetail deleteClaimDetail(ClaimDetail claimDetail) {
		return claimDetailPersistence.remove(claimDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ClaimDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return claimDetailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return claimDetailPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return claimDetailPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return claimDetailPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ClaimDetail fetchClaimDetail(long claimDetailId) {
		return claimDetailPersistence.fetchByPrimaryKey(claimDetailId);
	}
	...
	public ClaimDetail getClaimDetail(long claimDetailId)
		...
		return claimDetailPersistence.findByPrimaryKey(claimDetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(claimDetailLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ClaimDetail.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("claimDetailId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			claimDetailLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ClaimDetail.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return claimDetailLocalService.deleteClaimDetail(
			(ClaimDetail)persistedModel);
	}

	public BasePersistence<ClaimDetail> getBasePersistence() {
		return claimDetailPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return claimDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ClaimDetail> getClaimDetails(int start, int end) {
		return claimDetailPersistence.findAll(start, end);
	}
	...
	public int getClaimDetailsCount() {
		return claimDetailPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ClaimDetailLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		claimDetailLocalService = (ClaimDetailLocalService)aopProxy;

		_setLocalServiceUtilService(claimDetailLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClaimDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = claimDetailPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ClaimDetailLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, claimDetailLocalService);
		}
	...
	protected ClaimDetailLocalService claimDetailLocalService;
