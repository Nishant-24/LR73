...
public abstract class StagingClientGroupLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingClientGroupLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingClientGroupLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(stagingClientGroupLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				StagingClientGroupLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, stagingClientGroupLocalService);
		}
