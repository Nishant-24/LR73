...
import com.argus.oth.cases.management.service.StagingClientLocalServiceUtil;
...
/**
 * Provides the base implementation for the staging client local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.argus.oth.cases.management.service.impl.StagingClientLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.argus.oth.cases.management.service.impl.StagingClientLocalServiceImpl
 * @generated
 */
public abstract class StagingClientLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, StagingClientLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingClientLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingClientLocalServiceUtil</code>.
	 */
	...
	public StagingClient addStagingClient(StagingClient stagingClient) {
		...
		return stagingClientPersistence.update(stagingClient);
	}
	...
	public StagingClient createStagingClient(long stagingClientId) {
		return stagingClientPersistence.create(stagingClientId);
	}
	...
	public StagingClient deleteStagingClient(long stagingClientId)
		...
		return stagingClientPersistence.remove(stagingClientId);
	}
	...
	public StagingClient deleteStagingClient(StagingClient stagingClient) {
		return stagingClientPersistence.remove(stagingClient);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			StagingClient.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stagingClientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return stagingClientPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stagingClientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return stagingClientPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public StagingClient fetchStagingClient(long stagingClientId) {
		return stagingClientPersistence.fetchByPrimaryKey(stagingClientId);
	}
	...
	public StagingClient getStagingClient(long stagingClientId)
		...
		return stagingClientPersistence.findByPrimaryKey(stagingClientId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stagingClientLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StagingClient.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("stagingClientId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(StagingClient.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return stagingClientLocalService.deleteStagingClient(
			(StagingClient)persistedModel);
	}

	public BasePersistence<StagingClient> getBasePersistence() {
		return stagingClientPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return stagingClientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<StagingClient> getStagingClients(int start, int end) {
		return stagingClientPersistence.findAll(start, end);
	}
	...
	public int getStagingClientsCount() {
		return stagingClientPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StagingClientLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		stagingClientLocalService = (StagingClientLocalService)aopProxy;

		_setLocalServiceUtilService(stagingClientLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StagingClientLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stagingClientPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = StagingClientLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stagingClientLocalService);
		}
	...
	protected StagingClientLocalService stagingClientLocalService;
