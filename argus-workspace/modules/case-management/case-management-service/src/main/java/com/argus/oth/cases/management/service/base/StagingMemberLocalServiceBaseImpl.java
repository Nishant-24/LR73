...
import com.argus.oth.cases.management.service.StagingMemberLocalServiceUtil;
...
public abstract class StagingMemberLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingMemberLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingMemberLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(stagingMemberLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = StagingMemberLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stagingMemberLocalService);
		}
