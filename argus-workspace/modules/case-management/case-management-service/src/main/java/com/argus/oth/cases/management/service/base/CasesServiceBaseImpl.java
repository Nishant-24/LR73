...
public abstract class CasesServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CasesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CasesServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setServiceUtilService(casesService);
	}
	...
	private void _setServiceUtilService(CasesService casesService) {
		try {
			Field field = CasesServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, casesService);
		}
