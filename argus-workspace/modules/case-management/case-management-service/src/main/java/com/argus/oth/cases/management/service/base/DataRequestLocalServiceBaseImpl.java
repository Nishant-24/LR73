...
import com.argus.oth.cases.management.service.DataRequestLocalServiceUtil;
...
public abstract class DataRequestLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DataRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DataRequestLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(dataRequestLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DataRequestLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dataRequestLocalService);
		}
