...
public abstract class AuthProcedureLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AuthProcedureLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AuthProcedureLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(authProcedureLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AuthProcedureLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, authProcedureLocalService);
		}
