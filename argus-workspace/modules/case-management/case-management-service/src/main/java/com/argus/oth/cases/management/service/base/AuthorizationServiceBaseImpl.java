...
/**
 * Provides the base implementation for the authorization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.argus.oth.cases.management.service.impl.AuthorizationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.argus.oth.cases.management.service.impl.AuthorizationServiceImpl
 * @generated
 */
public abstract class AuthorizationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AuthorizationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AuthorizationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AuthorizationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AuthorizationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		authorizationService = (AuthorizationService)aopProxy;

		_setServiceUtilService(authorizationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AuthorizationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = AuthorizationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, authorizationService);
		}
	...
	@Reference
	protected com.argus.oth.cases.management.service.AuthorizationLocalService
