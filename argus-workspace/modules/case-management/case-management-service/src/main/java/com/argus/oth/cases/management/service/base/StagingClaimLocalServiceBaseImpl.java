...
import com.argus.oth.cases.management.service.StagingClaimLocalServiceUtil;
...
/**
 * Provides the base implementation for the staging claim local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.argus.oth.cases.management.service.impl.StagingClaimLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.argus.oth.cases.management.service.impl.StagingClaimLocalServiceImpl
 * @generated
 */
public abstract class StagingClaimLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, StagingClaimLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingClaimLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingClaimLocalServiceUtil</code>.
	 */
	...
	public StagingClaim addStagingClaim(StagingClaim stagingClaim) {
		...
		return stagingClaimPersistence.update(stagingClaim);
	}
	...
	public StagingClaim createStagingClaim(long stagingClaimId) {
		return stagingClaimPersistence.create(stagingClaimId);
	}
	...
	public StagingClaim deleteStagingClaim(long stagingClaimId)
		...
		return stagingClaimPersistence.remove(stagingClaimId);
	}
	...
	public StagingClaim deleteStagingClaim(StagingClaim stagingClaim) {
		return stagingClaimPersistence.remove(stagingClaim);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			StagingClaim.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stagingClaimPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return stagingClaimPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stagingClaimPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return stagingClaimPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public StagingClaim fetchStagingClaim(long stagingClaimId) {
		return stagingClaimPersistence.fetchByPrimaryKey(stagingClaimId);
	}
	...
	public StagingClaim getStagingClaim(long stagingClaimId)
		...
		return stagingClaimPersistence.findByPrimaryKey(stagingClaimId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stagingClaimLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StagingClaim.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("stagingClaimId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(StagingClaim.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return stagingClaimLocalService.deleteStagingClaim(
			(StagingClaim)persistedModel);
	}

	public BasePersistence<StagingClaim> getBasePersistence() {
		return stagingClaimPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return stagingClaimPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<StagingClaim> getStagingClaims(int start, int end) {
		return stagingClaimPersistence.findAll(start, end);
	}
	...
	public int getStagingClaimsCount() {
		return stagingClaimPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StagingClaimLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		stagingClaimLocalService = (StagingClaimLocalService)aopProxy;

		_setLocalServiceUtilService(stagingClaimLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StagingClaimLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stagingClaimPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = StagingClaimLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stagingClaimLocalService);
		}
	...
	protected StagingClaimLocalService stagingClaimLocalService;
