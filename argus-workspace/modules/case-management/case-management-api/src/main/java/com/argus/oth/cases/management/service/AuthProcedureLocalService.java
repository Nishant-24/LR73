...
/**
 * Provides the local service interface for AuthProcedure. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuthProcedureLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AuthProcedureLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.AuthProcedureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the auth procedure local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuthProcedureLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AuthProcedure addAuthProcedure(
		...
		String description, Date externalModifiedDate,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AuthProcedure fetchAuthProcedureByA_M(
		String authNumber, String medicalCodeId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AuthProcedure> fetchAuthProceduresByAuthNumber(
		String authNumber);
