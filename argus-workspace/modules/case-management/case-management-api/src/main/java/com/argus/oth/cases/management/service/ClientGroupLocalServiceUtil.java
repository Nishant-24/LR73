...
public class ClientGroupLocalServiceUtil {
	 ...
	 */
	public static ClientGroup addClientGroup(ClientGroup clientGroup) {
	 ...
	 */
	public static ClientGroup addClientGroup(
	 ...
	 */
	public static ClientGroup createClientGroup(long clientGroupId) {
	 ...
	 */
	public static ClientGroup deleteClientGroup(ClientGroup clientGroup) {
	 ...
	 */
	public static ClientGroup deleteClientGroup(long clientGroupId)
	...
	public static ClientGroup fetchClientGroup(long clientGroupId) {
	 ...
	 * @throws PortalException if a client group with the primary key could not be found
	 */
	public static ClientGroup getClientGroup(long clientGroupId)
		throws PortalException {
	 ...
	 */
	public static List<ClientGroup> getClientGroups(int start, int end) {
	 ...
	 */
	public static ClientGroup updateClientGroup(ClientGroup clientGroup) {
	...
	private static volatile ClientGroupLocalService _service;
