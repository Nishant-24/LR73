...
/**
 * Provides the local service interface for StagingClient. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StagingClientLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StagingClientLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.StagingClientLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the staging client local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StagingClientLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public StagingClient addStagingClient(StagingClient stagingClient);
	...
	public StagingClient createStagingClient(long stagingClientId);
	...
	public StagingClient deleteStagingClient(long stagingClientId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public StagingClient deleteStagingClient(StagingClient stagingClient);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StagingClient fetchStagingClient(long stagingClientId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StagingClient getStagingClient(long stagingClientId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StagingClient> getStagingClients(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StagingClient> getStagingClientsByClientId(String clientId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StagingClient> getStagingClientsByRowProcessed(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public StagingClient updateStagingClient(StagingClient stagingClient);
