...
public class ClaimDetailLocalServiceUtil {
	 ...
	 */
	public static ClaimDetail addClaimDetail(ClaimDetail claimDetail) {
	 ...
	 */
	public static ClaimDetail addClaimDetail(
	 ...
	 */
	public static ClaimDetail createClaimDetail(long claimDetailId) {
	 ...
	 */
	public static ClaimDetail deleteClaimDetail(ClaimDetail claimDetail) {
	 ...
	 */
	public static ClaimDetail deleteClaimDetail(long claimDetailId)
	...
	public static ClaimDetail fetchClaimDetail(long claimDetailId) {
	...
	public static List<ClaimDetail> getByExternalClaimId(long externalClaimId) {
	 ...
	 * @throws PortalException if a claim detail with the primary key could not be found
	 */
	public static ClaimDetail getClaimDetail(long claimDetailId)
		throws PortalException {
	 ...
	 */
	public static List<ClaimDetail> getClaimDetails(int start, int end) {
	 ...
	 */
	public static ClaimDetail updateClaimDetail(ClaimDetail claimDetail) {
	...
	private static volatile ClaimDetailLocalService _service;
