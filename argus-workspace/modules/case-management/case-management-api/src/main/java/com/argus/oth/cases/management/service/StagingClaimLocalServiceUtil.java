...
public class StagingClaimLocalServiceUtil {
	 ...
	 */
	public static StagingClaim addStagingClaim(
	 ...
	 */
	public static StagingClaim addStagingClaim(StagingClaim stagingClaim) {
	 ...
	 */
	public static StagingClaim createStagingClaim(long stagingClaimId) {
	 ...
	 */
	public static StagingClaim deleteStagingClaim(long stagingClaimId)
		throws PortalException {
	 ...
	 * @return the staging claim that was removed
	 */
	public static StagingClaim deleteStagingClaim(StagingClaim stagingClaim) {
	...
	public static StagingClaim fetchStagingClaim(long stagingClaimId) {
	 ...
	 * @throws PortalException if a staging claim with the primary key could not be found
	 */
	public static StagingClaim getStagingClaim(long stagingClaimId)
		throws PortalException {
	 ...
	 */
	public static List<StagingClaim> getStagingClaims(int start, int end) {
	 ...
	 */
	public static StagingClaim updateStagingClaim(StagingClaim stagingClaim) {
	...
	private static volatile StagingClaimLocalService _service;
