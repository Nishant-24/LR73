...
public class DataRequestLocalServiceUtil {
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect DataRequestLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param dataRequest the data request
	 * @return the data request that was added
	 */
	public static DataRequest addDataRequest(DataRequest dataRequest) {
	 ...
	 */
	public static DataRequest addDataRequest(
	 ...
	 */
	public static DataRequest createDataRequest(long dataRequestId) {
	 ...
	 */
	public static DataRequest deleteDataRequest(DataRequest dataRequest) {
	 ...
	 */
	public static DataRequest deleteDataRequest(long dataRequestId)
	...
	public static DataRequest fetchByExternalCaseId_Type(
		long externalCaseId, String type) {

		return getService().fetchByExternalCaseId_Type(externalCaseId, type);
	}

	public static DataRequest fetchDataRequest(long dataRequestId) {
	 ...
	 * @throws PortalException if a data request with the primary key could not be found
	 */
	public static DataRequest getDataRequest(long dataRequestId)
		throws PortalException {
	 ...
	 */
	public static List<DataRequest> getDataRequests(int start, int end) {
	...
	public static DataRequest setDataRequestLastUpdatedDate(
		long clientId, long caseId, long externalCaseId, String type) {
	 ...
	 */
	public static DataRequest updateDataRequest(DataRequest dataRequest) {
		return getService().updateDataRequest(dataRequest);
	}

	public static DataRequest updateDataRequest(
		long clientId, long caseId, long externalCaseId, String type,
		java.util.Date lastUpdatedDate) {
	...
	private static volatile DataRequestLocalService _service;
