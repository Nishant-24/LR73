...
public class StagingReferenceTypeCodeLocalServiceUtil {
	 ...
	 */
	public static StagingReferenceTypeCode addStagingReferenceTypeCode(
	 ...
	 */
	public static StagingReferenceTypeCode createStagingReferenceTypeCode(
	 ...
	 */
	public static StagingReferenceTypeCode deleteStagingReferenceTypeCode(
			long stagingReferenceTypeCodeId)
		throws PortalException {
	...
	public static StagingReferenceTypeCode fetchStagingReferenceTypeCode(
		long stagingReferenceTypeCodeId) {
	 ...
	 * @throws PortalException if a staging reference type code with the primary key could not be found
	 */
	public static StagingReferenceTypeCode getStagingReferenceTypeCode(
			long stagingReferenceTypeCodeId)
		throws PortalException {
	 ...
	 */
	public static List<StagingReferenceTypeCode> getStagingReferenceTypeCodes(
		int start, int end) {
	 ...
	 */
	public static StagingReferenceTypeCode updateStagingReferenceTypeCode(
		StagingReferenceTypeCode stagingReferenceTypeCode) {
	...
	private static volatile StagingReferenceTypeCodeLocalService _service;
