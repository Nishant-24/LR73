...
public class StagingAuthProcedureLocalServiceUtil {
	 ...
	 */
	public static StagingAuthProcedure addStagingAuthProcedure(
	 ...
	 */
	public static StagingAuthProcedure createStagingAuthProcedure(
	 ...
	 */
	public static StagingAuthProcedure deleteStagingAuthProcedure(
			long stagingAuthProcedureId)
		throws PortalException {
	...
	public static StagingAuthProcedure fetchStagingAuthProcedure(
		long stagingAuthProcedureId) {
	 ...
	 * @throws PortalException if a staging auth procedure with the primary key could not be found
	 */
	public static StagingAuthProcedure getStagingAuthProcedure(
			long stagingAuthProcedureId)
		throws PortalException {
	 ...
	 */
	public static List<StagingAuthProcedure> getStagingAuthProcedures(
		int start, int end) {
	 ...
	 */
	public static StagingAuthProcedure updateStagingAuthProcedure(
		StagingAuthProcedure stagingAuthProcedure) {
	...
	private static volatile StagingAuthProcedureLocalService _service;
