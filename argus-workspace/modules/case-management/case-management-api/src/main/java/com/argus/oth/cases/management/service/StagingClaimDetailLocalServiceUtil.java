...
public class StagingClaimDetailLocalServiceUtil {
	 ...
	 */
	public static StagingClaimDetail addStagingClaimDetail(
	 ...
	 */
	public static StagingClaimDetail createStagingClaimDetail(
	 ...
	 */
	public static StagingClaimDetail deleteStagingClaimDetail(
			long stagingClaimDetailId)
		throws PortalException {
	...
	public static StagingClaimDetail fetchStagingClaimDetail(
		long stagingClaimDetailId) {
	 ...
	 * @throws PortalException if a staging claim detail with the primary key could not be found
	 */
	public static StagingClaimDetail getStagingClaimDetail(
			long stagingClaimDetailId)
		throws PortalException {
	 ...
	 */
	public static List<StagingClaimDetail> getStagingClaimDetails(
		int start, int end) {
	 ...
	 */
	public static StagingClaimDetail updateStagingClaimDetail(
		StagingClaimDetail stagingClaimDetail) {
	...
	private static volatile StagingClaimDetailLocalService _service;
