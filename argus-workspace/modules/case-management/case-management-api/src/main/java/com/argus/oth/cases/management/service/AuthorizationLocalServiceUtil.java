...
public class AuthorizationLocalServiceUtil {
	 ...
	 */
	public static Authorization addAuthorization(Authorization authorization) {
	 ...
	 */
	public static Authorization createAuthorization(long authorizationId) {
	 ...
	 */
	public static Authorization deleteAuthorization(
	 ...
	 */
	public static Authorization deleteAuthorization(long authorizationId)
	...
	public static Authorization fetchAuthorization(long authorizationId) {
		return getService().fetchAuthorization(authorizationId);
	}

	public static Authorization fetchAuthorizationByExternalAuthorizationId(
	 ...
	 */
	public static Authorization fetchAuthorizationByUuidAndGroupId(
	 ...
	 * @throws PortalException if a authorization with the primary key could not be found
	 */
	public static Authorization getAuthorization(long authorizationId)
		throws PortalException {
	 ...
	 */
	public static Authorization getAuthorizationByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {
	 ...
	 */
	public static List<Authorization> getAuthorizations(int start, int end) {
		return getService().getAuthorizations(start, end);
	}

	public static List<Authorization> getAuthorizationsByAuthNumber(
		String authNumber) {

		return getService().getAuthorizationsByAuthNumber(authNumber);
	}

	public static List<Authorization> getAuthorizationsByCaseId(long caseId) {
		return getService().getAuthorizationsByCaseId(caseId);
	}

	public static List<Authorization> getAuthorizationsByCaseId(
	 ...
	 */
	public static List<Authorization> getAuthorizationsByUuidAndCompanyId(
	 ...
	 */
	public static Authorization updateAuthorization(
		Authorization authorization) {
	...
	private static volatile AuthorizationLocalService _service;
