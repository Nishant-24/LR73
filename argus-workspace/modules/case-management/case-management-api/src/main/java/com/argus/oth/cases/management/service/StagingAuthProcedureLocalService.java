...
/**
 * Provides the local service interface for StagingAuthProcedure. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StagingAuthProcedureLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StagingAuthProcedureLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.StagingAuthProcedureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the staging auth procedure local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StagingAuthProcedureLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public StagingAuthProcedure addStagingAuthProcedure(
		...
		String description, String externalModifiedDate,
