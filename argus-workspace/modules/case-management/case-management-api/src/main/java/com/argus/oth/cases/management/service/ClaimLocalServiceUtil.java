...
public class ClaimLocalServiceUtil {
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect ClaimLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param claim the claim
	 * @return the claim that was added
	 */
	public static Claim addClaim(Claim claim) {
		return getService().addClaim(claim);
	}

	public static Claim addClaim(
	 ...
	 */
	public static Claim createClaim(long claimId) {
	 ...
	 */
	public static Claim deleteClaim(Claim claim) {
	 ...
	 */
	public static Claim deleteClaim(long claimId) throws PortalException {
	...
	public static Claim fetchClaim(long claimId) {
	...
	public static List<Claim> getByAuthorizationNumber(
	 ...
	 * @throws PortalException if a claim with the primary key could not be found
	 */
	public static Claim getClaim(long claimId) throws PortalException {
	 ...
	 */
	public static List<Claim> getClaims(int start, int end) {
	...
	private static volatile ClaimLocalService _service;
