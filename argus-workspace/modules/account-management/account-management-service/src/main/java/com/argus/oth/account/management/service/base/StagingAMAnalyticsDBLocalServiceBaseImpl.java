...
import com.argus.oth.account.management.service.StagingAMAnalyticsDBLocalServiceUtil;
...
public abstract class StagingAMAnalyticsDBLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingAMAnalyticsDBLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingAMAnalyticsDBLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(stagingAMAnalyticsDBLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				StagingAMAnalyticsDBLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, stagingAMAnalyticsDBLocalService);
		}
