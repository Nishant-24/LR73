...
public abstract class StagingAMAnalyticsClaimLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingAMAnalyticsClaimLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingAMAnalyticsClaimLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(stagingAMAnalyticsClaimLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				StagingAMAnalyticsClaimLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, stagingAMAnalyticsClaimLocalService);
		}
