...
public interface StagingAMAnalyticsClaimLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.argus.oth.account.management.service.impl.StagingAMAnalyticsClaimLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the staging am analytics claim local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StagingAMAnalyticsClaimLocalServiceUtil} if injection and service tracking are not available.
	 */
