...
public class StagingAMAnalyticsDBLocalServiceUtil {
	 ...
	 */
	public static StagingAMAnalyticsDB add(
	 ...
	 */
	public static StagingAMAnalyticsDB addStagingAMAnalyticsDB(
	 ...
	 */
	public static StagingAMAnalyticsDB createStagingAMAnalyticsDB(
	 ...
	 */
	public static StagingAMAnalyticsDB deleteStagingAMAnalyticsDB(
			long stagingAMAnalyticsDbId)
		throws PortalException {
	...
	public static StagingAMAnalyticsDB fetchStagingAMAnalyticsDB(
		long stagingAMAnalyticsDbId) {
	 ...
	 * @throws PortalException if a staging am analytics db with the primary key could not be found
	 */
	public static StagingAMAnalyticsDB getStagingAMAnalyticsDB(
			long stagingAMAnalyticsDbId)
		throws PortalException {
	 ...
	 */
	public static List<StagingAMAnalyticsDB> getStagingAMAnalyticsDBs(
		int start, int end) {
	 ...
	 */
	public static StagingAMAnalyticsDB updateStagingAMAnalyticsDB(
		StagingAMAnalyticsDB stagingAMAnalyticsDB) {
	...
	private static volatile StagingAMAnalyticsDBLocalService _service;
