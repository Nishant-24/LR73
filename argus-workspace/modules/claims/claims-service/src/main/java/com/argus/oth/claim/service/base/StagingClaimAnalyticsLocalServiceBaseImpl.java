...
public abstract class StagingClaimAnalyticsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StagingClaimAnalyticsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StagingClaimAnalyticsLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(stagingClaimAnalyticsLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				StagingClaimAnalyticsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, stagingClaimAnalyticsLocalService);
		}
