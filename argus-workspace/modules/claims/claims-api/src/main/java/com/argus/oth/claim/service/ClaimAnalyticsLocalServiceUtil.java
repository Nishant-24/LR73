...
public class ClaimAnalyticsLocalServiceUtil {
	 ...
	 */
	public static ClaimAnalytics addClaimAnalytics(
	 ...
	 */
	public static ClaimAnalytics createClaimAnalytics(long claimAnalyticsId) {
	 ...
	 */
	public static ClaimAnalytics deleteClaimAnalytics(
		ClaimAnalytics claimAnalytics) {
	 ...
	 */
	public static ClaimAnalytics deleteClaimAnalytics(long claimAnalyticsId)
	...
	public static ClaimAnalytics fetchClaimAnalytics(long claimAnalyticsId) {
	...
	public static List<ClaimAnalytics> getByE_C(
		long externalClientId, String claimStatus) {

		return getService().getByE_C(externalClientId, claimStatus);
	}

	public static List<ClaimAnalytics> getByExternalClientId(
	 ...
	 * @throws PortalException if a claim analytics with the primary key could not be found
	 */
	public static ClaimAnalytics getClaimAnalytics(long claimAnalyticsId)
		throws PortalException {
	 ...
	 */
	public static List<ClaimAnalytics> getClaimAnalyticses(int start, int end) {
	...
	public static List<ClaimAnalytics> search(
	 ...
	 */
	public static ClaimAnalytics updateClaimAnalytics(
		ClaimAnalytics claimAnalytics) {
	...
	private static volatile ClaimAnalyticsLocalService _service;
