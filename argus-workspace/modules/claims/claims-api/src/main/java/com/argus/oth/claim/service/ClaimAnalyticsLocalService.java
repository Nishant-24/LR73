...
public interface ClaimAnalyticsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.argus.oth.claim.service.impl.ClaimAnalyticsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the claim analytics local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ClaimAnalyticsLocalServiceUtil} if injection and service tracking are not available.
	 */
