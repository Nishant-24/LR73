...
public class StagingClaimAnalyticsLocalServiceUtil {
	 ...
	 */
	public static StagingClaimAnalytics addStagingClaimAnalytics(
	 ...
	 */
	public static StagingClaimAnalytics createStagingClaimAnalytics(
	 ...
	 */
	public static StagingClaimAnalytics deleteStagingClaimAnalytics(
			long stagingClaimAnalyticsId)
		throws PortalException {
	...
	public static StagingClaimAnalytics fetchStagingClaimAnalytics(
		long stagingClaimAnalyticsId) {
	 ...
	 * @throws PortalException if a staging claim analytics with the primary key could not be found
	 */
	public static StagingClaimAnalytics getStagingClaimAnalytics(
			long stagingClaimAnalyticsId)
		throws PortalException {
	 ...
	 */
	public static List<StagingClaimAnalytics> getStagingClaimAnalyticses(
		int start, int end) {
	 ...
	 */
	public static StagingClaimAnalytics updateStagingClaimAnalytics(
		StagingClaimAnalytics stagingClaimAnalytics) {
	...
	private static volatile StagingClaimAnalyticsLocalService _service;
