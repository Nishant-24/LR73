...
public interface TaskPersistence extends BasePersistence<Task> {
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByC_NotP(long caseId, String processStatus);
	 ...
	 * @return the range of matching tasks
	 */
	public java.util.List<Task> findByC_NotP(
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByE_P(
	 ...
	 * @return the matching tasks
	 */
	public java.util.List<Task> findByRowProcessed_ProcessStatus(
