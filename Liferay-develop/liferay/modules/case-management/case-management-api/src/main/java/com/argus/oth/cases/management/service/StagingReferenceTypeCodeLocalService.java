...
public interface StagingReferenceTypeCodeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StagingReferenceTypeCodeLocalServiceUtil} to access the staging reference type code local service. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.StagingReferenceTypeCodeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
