...
@Component(
	...
	property = {
		...
		"com.liferay.portlet.display-category=Argus",
...
public class LoginPortlet extends MVCPortlet {
	...
	@Reference(
		target = "(&(release.bundle.symbolic.name=com.argus.login.web)(&(release.schema.version>=1.0.0)(!(release.schema.version>=2.0.0))))",
		unbind = "-"
	)
