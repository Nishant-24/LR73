...
/**
 * Provides the local service interface for StagingAMAnalyticsDB. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StagingAMAnalyticsDBLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StagingAMAnalyticsDBLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StagingAMAnalyticsDBLocalServiceUtil} to access the staging am analytics db local service. Add custom service methods to <code>com.argus.oth.account.management.service.impl.StagingAMAnalyticsDBLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
