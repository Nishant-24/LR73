 ...
 */
@Component(
	immediate = true, property = "indexer.class.name=com.argus.oth.account.management.model.AMAnalyticsClaim",
	service = ModelPreFilterContributor.class
)
public class AMAClaimPreFilterContributor implements ModelPreFilterContributor {
	...
	public void contribute(
		...
		booleanFilter.addRangeTerm(
			Field.getSortableFieldName(OTHConstants.FIELD_AM_ANALYTICS_CLAIM_DATE), startDate, endDate);
	}
