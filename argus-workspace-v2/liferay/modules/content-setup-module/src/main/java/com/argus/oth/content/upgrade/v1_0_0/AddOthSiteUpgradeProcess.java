...
public class AddOthSiteUpgradeProcess extends UpgradeProcess {
	...
	protected Group addGroup(long companyId, String name, String description, int type, String friendlyURL)
		...
		return _groupLocalService.addGroup(
			_userLocalService.getDefaultUserId(companyId), GroupConstants.DEFAULT_PARENT_GROUP_ID, null, 0, 0, nameMap,
	...
	//keep so that instanceable portlet instance is available when adding this portlet to pages
