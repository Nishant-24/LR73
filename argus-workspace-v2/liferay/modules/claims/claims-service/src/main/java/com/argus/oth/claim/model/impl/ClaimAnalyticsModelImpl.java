...
public class ClaimAnalyticsModelImpl
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ClaimAnalytics)) {
			return false;
		}

		ClaimAnalytics claimAnalytics = (ClaimAnalytics)obj;
	...
	public void resetOriginalValues() {
		ClaimAnalyticsModelImpl claimAnalyticsModelImpl = this;

		claimAnalyticsModelImpl._setModifiedDate = false;

		claimAnalyticsModelImpl._originalExternalClientId =
			claimAnalyticsModelImpl._externalClientId;

		claimAnalyticsModelImpl._setOriginalExternalClientId = false;

		claimAnalyticsModelImpl._originalClaimStatus =
			claimAnalyticsModelImpl._claimStatus;

		claimAnalyticsModelImpl._columnBitmask = 0;
	}
