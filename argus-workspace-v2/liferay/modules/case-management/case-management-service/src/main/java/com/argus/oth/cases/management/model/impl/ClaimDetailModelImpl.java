...
public class ClaimDetailModelImpl
	...
	public void resetOriginalValues() {
		ClaimDetailModelImpl claimDetailModelImpl = this;

		claimDetailModelImpl._setModifiedDate = false;

		claimDetailModelImpl._originalLineId = claimDetailModelImpl._lineId;

		claimDetailModelImpl._setOriginalLineId = false;

		claimDetailModelImpl._originalExternalClaimId =
			claimDetailModelImpl._externalClaimId;

		claimDetailModelImpl._setOriginalExternalClaimId = false;

		claimDetailModelImpl._originalRowProcessed =
			claimDetailModelImpl._rowProcessed;

		claimDetailModelImpl._columnBitmask = 0;
	}
