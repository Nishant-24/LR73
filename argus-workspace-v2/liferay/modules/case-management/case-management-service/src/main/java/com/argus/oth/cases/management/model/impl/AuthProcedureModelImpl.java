...
public class AuthProcedureModelImpl
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AuthProcedure)) {
			return false;
		}

		AuthProcedure authProcedure = (AuthProcedure)obj;
	...
	public void resetOriginalValues() {
		AuthProcedureModelImpl authProcedureModelImpl = this;

		authProcedureModelImpl._setModifiedDate = false;

		authProcedureModelImpl._originalExternalAuthorizationId =
			authProcedureModelImpl._externalAuthorizationId;

		authProcedureModelImpl._setOriginalExternalAuthorizationId = false;

		authProcedureModelImpl._originalAuthNumber =
			authProcedureModelImpl._authNumber;

		authProcedureModelImpl._originalMedicalCodeId =
			authProcedureModelImpl._medicalCodeId;

		authProcedureModelImpl._columnBitmask = 0;
	}
