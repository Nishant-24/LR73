...
public class ClientGroupModelImpl
	...
	public void resetOriginalValues() {
		ClientGroupModelImpl clientGroupModelImpl = this;

		clientGroupModelImpl._setModifiedDate = false;

		clientGroupModelImpl._originalExternalClientGroupId =
			clientGroupModelImpl._externalClientGroupId;

		clientGroupModelImpl._setOriginalExternalClientGroupId = false;

		clientGroupModelImpl._originalRowProcessed =
			clientGroupModelImpl._rowProcessed;

		clientGroupModelImpl._columnBitmask = 0;
	}
