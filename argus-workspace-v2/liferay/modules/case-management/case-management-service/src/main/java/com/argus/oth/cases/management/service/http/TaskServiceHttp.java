...
public class TaskServiceHttp {
	...
	public static com.liferay.portal.kernel.json.JSONObject addTask(
			...
			String descriptionKey, String startDateString,
			java.util.Date endDate, java.util.Date dueDate, long externalTaskId,
			String priorityKey, String status, String processStatus,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, uuid, groupId, caseId, descriptionKey,
				startDateString, endDate, dueDate, externalTaskId, priorityKey,
				status, processStatus, failureDescription, createdUserId);
	...
	public static java.util.List<com.argus.oth.cases.management.model.Task>
		...
		try {
			MethodKey methodKey = new MethodKey(
				TaskServiceUtil.class, "getTasksByCaseId",
				_getTasksByCaseIdParameterTypes1);
			...
			return (java.util.List<com.argus.oth.cases.management.model.Task>)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	private static final Class<?>[] _getTasksByCaseIdParameterTypes1 =
