...
public class DataRequestModelImpl
	...
	public void resetOriginalValues() {
		DataRequestModelImpl dataRequestModelImpl = this;

		dataRequestModelImpl._originalClientId = dataRequestModelImpl._clientId;

		dataRequestModelImpl._setOriginalClientId = false;

		dataRequestModelImpl._originalExternalCaseId =
			dataRequestModelImpl._externalCaseId;

		dataRequestModelImpl._setOriginalExternalCaseId = false;

		dataRequestModelImpl._originalType = dataRequestModelImpl._type;

		dataRequestModelImpl._columnBitmask = 0;
	}
