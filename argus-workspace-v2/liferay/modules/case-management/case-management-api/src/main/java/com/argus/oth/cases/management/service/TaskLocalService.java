...
public interface TaskLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaskLocalServiceUtil} to access the task local service. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public Task addTask(
		long groupId, long caseId, String description, Date startDate,
		Date endDate, Date dueDate, long externalTaskId, String priority,
		String status, String randomString);

	public Task addTask(
		String uuid, long groupId, long caseId, String description,
		Date startDate, Date endDate, Date dueDate, long externalTaskId,
		String priority, String status, String processStatus,
		String failureDescription, long createdUserId, String randomString);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Task> getTasksByC_NotP(
	...
	public Task updateTask(
		long taskId, String description, Date startDate, Date endDate,
		Date dueDate, String priority, String status, String processStatus);
