...
public interface StagingAuthProcedureLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StagingAuthProcedureLocalServiceUtil} to access the staging auth procedure local service. Add custom service methods to <code>com.argus.oth.cases.management.service.impl.StagingAuthProcedureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
